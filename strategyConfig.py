...
sellStrategy2 = {"profit":1.10, "sell":0.5}#盈利10%时，卖出20%的仓位
sellStrategy3 = {"profit":1.20, "sell":0.3}#盈利20%时，卖出20%的仓位
...
binance_coinBase_count = 10 #代表100个USDT
binance_tradeCoin = "MKR"#交易目标是 DOGE 币，
